DROP FUNCTION IF EXISTS public.get_blockchains_extention();

DROP TYPE IF EXISTS public.temp_t_get_blockchains_extention;

CREATE TYPE public.temp_t_get_blockchains_extention as (
    network_id character varying,
    base_token character varying,
    inflation numeric,
    staking_apr numeric,
    unbonding_period integer,
    bonded_tokens numeric,
    bonded_tokens_percent numeric,
    validators_cnt integer,
    nodes_cnt integer
);
