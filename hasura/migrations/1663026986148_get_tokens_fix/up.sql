...
DROP TYPE IF EXISTS public.temp_t_get_tokens;

CREATE TYPE public.temp_t_get_tokens as (
    blockchain character varying,
    denom character varying,
    symbol character varying,
    logo_url character varying,
    price numeric,
    price_day_diff_percent numeric,
    price_week_diff_percent numeric,
    market_cap numeric,
    on_chain_supply numeric,
    token_day_trading_volume numeric,
    token_day_trading_volume_diff_percent numeric,
    price_month_diff_percent numeric
);
...
, prices as (
    SELECT DISTINCT on (blockchain, denom)
        ...
        symbol_supply as on_chain_supply,
...
ALTER TABLE "flat"."tokens" ALTER COLUMN "market_cap" TYPE numeric;

ALTER TABLE "flat"."tokens" ALTER COLUMN "on_chain_supply" TYPE numeric;

ALTER TABLE "flat"."tokens" ALTER COLUMN "token_day_trading_volume" TYPE numeric;
