...
CREATE TYPE public.temp_t_get_blockchain_stats as (
    ...
    active_addresses_cnt integer,
    active_addresses_cnt_diff integer,
    ibc_active_addresses_percent numeric
);
...
select
    ...
    coalesce(current_ibc_active_addresses.ibc_active_addresses_cnt, 0)::integer as ibc_active_addresses_cnt,
    coalesce(current_ibc_active_addresses.ibc_active_addresses_cnt - previous_ibc_active_addresses.ibc_active_addresses_cnt, 0)::integer as ibc_active_addresses_cnt_diff,
