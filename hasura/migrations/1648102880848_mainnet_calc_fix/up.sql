...
, channels_cashflow_tracked_stats as (
    select
        ...
        stats.channel,
        stats.counterparty_channel,
        stats.is_channel_calculable,
        stats.is_counterparty_channel_calculable,
        stats.client_id,
        stats.connection_id,
        stats.is_opened,
        stats.cashflow_in,
        stats.cashflow_in_diff,
        stats.cashflow_in_pending,
        stats.cashflow_out,
        stats.cashflow_out_diff,
        stats.cashflow_out_pending,
        stats.chart
    from
        get_channels_cashflow_stats(period_in_hours, step_in_hours, is_mainnet_only) as stats
    left join zones on stats.counterparty_zone = zones.chain_id
    where
        zones.is_mainnet = is_mainnet_only or zones.is_mainnet = true
)
...
, channels_transfers_tracked_stats as (
    select
        ...
        stats.tx_out,
        stats.tx_out_diff,
        stats.tx_out_pending,
        stats.chart,
        stats.failed_tx
    from
        get_channels_transfers_stats(period_in_hours, step_in_hours, is_mainnet_only) as stats
    left join zones on stats.counterparty_zone = zones.chain_id
    where
        zones.is_mainnet = is_mainnet_only or zones.is_mainnet = true
)
