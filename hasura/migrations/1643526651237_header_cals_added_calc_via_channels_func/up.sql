...
, cashflow_data as (
    ...
    from (
        select
            ...
            sum(cashflow_in_pending) as cashflow_pending
        from
        ...
        select
            ...
            sum(cashflow_out_pending) as cashflow_pending
        from
...
, transfers_data as (
    ...
    from (
        select
            ...
            sum(tx_in_pending) as tx_pending
        from
        ...
        select
            ...
            sum(tx_out_pending) as tx_pending
        from
...
, top_transfers_pair_json as (
    select
        ...
        'target', counterparty_zone,
        'txs', tx,
        'source_to_target_txs', tx_out,
        'target_to_source_txs', tx_in,
        'txs_diff', tx_diff,
        'txs_pending', tx_pending
