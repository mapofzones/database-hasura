DROP FUNCTION IF EXISTS public.get_blockchain_switched_stats();

DROP TYPE IF EXISTS public.temp_t_get_blockchain_switched_stats;

CREATE TYPE public.temp_t_get_blockchain_switched_stats as (
    ...
    ibc_peers integer,
    txs_rating integer,
    txs_rating_diff integer,
    ibc_active_addresses_cnt_rating integer,
    ibc_active_addresses_cnt_rating_diff integer,
    ibc_cashflow bigint,
    ...
    active_addresses_cnt_rating integer,
    active_addresses_cnt_rating_diff integer
);
